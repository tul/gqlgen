...
func (ec *executionContext) unmarshalInputInputDirectives(ctx context.Context, v interface{}) (InputDirectives, error) {
	...
	for k, v := range asMap {
		...
		case "innerNullable":
			var err error
			it.InnerNullable, err = ec.unmarshalOInnerDirectives2ᚖᚖgithubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚐInnerDirectives(ctx, v)
			if err != nil {
				return it, err
			}
		case "thirdParty":
...
func (ec *executionContext) unmarshalOInnerDirectives2ᚖᚖgithubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚐInnerDirectives(ctx context.Context, v interface{}) (**InnerDirectives, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalOInnerDirectives2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋcodegenᚋtestserverᚐInnerDirectives(ctx, v)
	return &res, err
}
